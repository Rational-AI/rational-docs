...
What is a [`workflow?`](#)  
Workflows automate the transformation of raw data into AI-ready knowledge. They handle the heavy lifting: extracting key information, augmenting it, identifying connections between data, and structuring everything into a queryable knowledge base your AI applications can use.
</Admonition>
