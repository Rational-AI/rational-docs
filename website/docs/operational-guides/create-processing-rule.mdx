...
<img
  src={require('@site/static/img/screens/processing-rules.png').default}
...
Being code, you can develop arbitrarily complex conditions to decide which workflow applies to your document, for example:
