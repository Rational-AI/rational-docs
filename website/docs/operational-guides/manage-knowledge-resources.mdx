...
2. On the resource card, open the **⋮** (kebab) menu — the same menu that holds **See details** and **Show/Hide**.
3. Select **Delete**.
...
<img
  ...
  alt="The options menu on a resource showing See details, Mark as hidden, and Delete"
  style={{ width: '100%', maxWidth: '300px', maxHeight: '100%', objectFit: 'contain', border: '1px solid #E4E4E7', borderRadius: '6px', boxSizing: 'border-box' }}
/>

*The resource menu, where each card's actions live.*
