...
* [Retrieval-Augmented Generation](./RAG.mdx): how relevant knowledge is selected and fitted into the context window.
* [Large Language Models](./LLMs.mdx): the models whose architecture sets the size of the window.
* [Prompts](./Prompts.mdx): how the instructions you write share that same window with the model's answer.
