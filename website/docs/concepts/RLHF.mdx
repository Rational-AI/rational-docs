...
* [Model training](./Model-training.mdx): the stages that lead up to alignment.
* [Finetuning](./Finetuning.mdx): adapting a model to a task or domain.
* [Prompts](./Prompts.mdx): how you steer an already aligned model at runtime.
