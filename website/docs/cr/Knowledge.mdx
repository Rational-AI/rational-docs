...
The **Knowledge** module is your central hub for storing, exploring and maintaining domain-specific information used by Rational AI. A knowledge set collects related resources (documents such as product catalogs and graphs) and organizes them into an interactive graph and searchable table. Use this module to ingest data, add metadata, view relationships between resources and prepare content for model ingestion.
...
* **Use search and filters** to quickly locate resources. Use the graph to discover indirect relationships and hidden patterns in your data.
